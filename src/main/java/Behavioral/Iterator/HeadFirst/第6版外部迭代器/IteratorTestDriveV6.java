package Behavioral.Iterator.HeadFirst.第6版外部迭代器;


import Behavioral.Iterator.HeadFirst.第6版外部迭代器.BaseClass.MenuComponent;
import Behavioral.Iterator.HeadFirst.第6版外部迭代器.Client.Waitress;
import Behavioral.Iterator.HeadFirst.第6版外部迭代器.ConcreteClass.Menu;
import Behavioral.Iterator.HeadFirst.第6版外部迭代器.ConcreteClass.MenuItem;

/**
 * Created by zhangjiantao on 2016/5/20.
 */
public class IteratorTestDriveV6 {
    ...
    private static MenuComponent getMenuComponent() {
        ...
        pancakeHouseMenu.add(new MenuItem("123Regular Pancake Breakfase", "Pancakes with fried eggs, sausage", false, 2.99));
